#!/usr/bin/env python3
# Adapted from https://github.com/cyrilkups/cyrilkups
"""
...
LINES = [
    ...
    (None, "", None, None),
    ("Highlight", "Break Through Tech AI / Team Anote", CYAN, WHITE),
    ("Highlight", "Accessibility-focused app projects", CYAN, WHITE),
    ("Highlight", "Technical problem-solving + creative thinking", CYAN, WHITE),
]
